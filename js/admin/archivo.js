...
function editarArchivo(idArc){
  ...
  var actual = window.location+'';
     ...
     var id = split[split.length-1];
        ...
        url: "/SIG/"+id+"/verificar-archivo/"+idArc,
        type: "get",
        dataType: "json",
        cache: false,
        error: function(element){}, 
          success: function(data){
            ...
            $.ajax({
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
            url: "/SIG/"+id+"/subcategoria-id/"+name[0].n_subcategoria,
            type: "GET",
            dataType: "json",
            cache: false,
            error: function(element){}, 
...
$('#m_modal_mover_carpeta').on('submit', function (e) {
    ...
    $.ajax({
        ...
        type: "post",
        url: "/SIG/admin/movimiento-archivo",
        data: formData,
        dataType: 'json',
        cache: false,
        success: function (data) {
        ...
        $.ajax(
            {
                ...
                type: "POST",
                url: "/SIG/admin/agregar-archivo/categoria",
                data: formData,
                dataType: 'json',
                cache: false,
                contentType: false,
   ...
   swal({
      ...
      preConfirm: function () {
        return new Promise(function (resolve, reject) {
              ...
              type: "get",
              url: "/SIG/usuario/eliminar-subcategoria/"+id,
              dataType: 'json',
              cache: false,
              success: function (data) {
                  if (data.estado == true) {
