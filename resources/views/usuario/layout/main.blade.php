            ...
            <div class="m-stack__item m-brand  m-brand--skin-light ">
              <div class="m-stack m-stack--ver m-stack--general m-stack--fluid" >
                <div class="m-stack__item m-stack__item--middle m-brand__logo" >
                  <a href="/SIG/usuario/dashboard" class="m-brand__logo-wrapper">
                          ...
                          <div class="m-dropdown__header m--align-center">
                            <div class="m-card-user m-card-user--skin-light">
                              ...
                              <div class="m-card-user__details">
                                <span class="m-card-user__name m--font-weight-500">{{$user->nombre}}</span>
                                <a href="" class="m-card-user__email m--font-weight-300 m-link"><small>{{$user->correo}}</small></a>
                              </div>
                            </div>
                          </div>
                          <div class="m-dropdown__body">
                            <div class="m-dropdown__content">
                              <ul class="m-nav m-nav--skin-light">
                                ...
                                <li class="m-nav__item">
                                  <a href="{{url('usuario/logout/')}}" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Cerrar Sesion</a>
                                </li>
                              </ul>
                            </div>
                          </div>
          ...
          <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
            <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
              ...
              <li class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1">
                <a href="{{url('/usuario/inicio/')}}" class="m-menu__link ">
                ...
                <div class="m-menu__submenu ">
                  ...
                  <ul class="m-menu__subnav">
                    ...
                    @foreach($categoria as $categ)
                      <li class="m-menu__item "  aria-haspopup="true">
                        <a href="{{url('/usuario/categoria/'.$categ->id.'')}}" id="{{$categ->id}}" class="m-menu__link ">
                          <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                            <span></span>
                          </i>
              ...
              <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                  <li class="m-nav__item m-nav__item--home">
                    <a href="{{url('/usuario/dashboard/')}}" class="m-nav__link m-nav__link--icon">
            ...
            <div class="modal-content">
                ...
                <form id="formulario-agregar-categoria">
                    <div class="modal-body">
                      ...
                      <input type="hidden" class="form-control" name="posicion" id ="posicion" value="7">
                    </div> 
