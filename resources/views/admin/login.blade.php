...
<html lang="es">
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action=""id="form-login-admin">
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="email" placeholder="Correo" name="correo" autocomplete="off">
								</div>
								<div class="form-group m-form__group">
								...
								<div class="m-login__form-action">
									<input type="submit" id="m_login_signin_submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air m-login__btn m-login__btn--primary" value = "Iniciar Sesion">
								</div>
							</form>
						</div>
		...
		<script src="/SIG/js/admin/login.js" type="text/javascript"></script>
