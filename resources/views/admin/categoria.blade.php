        ...
        <div class="m-dropdown__inner">
          <div class="m-dropdown__body">
            <div class="m-dropdown__content">
              <ul class="m-nav">
                <li class="m-nav__item"style="width:50px;">
                  <button type="button" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--outline-2x cat-editar"   idCat="{{$categorias->id}}"nomCat="{{$categorias->nombre}}"  data-toggle="modal" data-target="#m_modal_editar_categoria" ">
                ...
                <li class="m-nav__item">
                  <button type="button" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--outline-2x" onclick="eliminarCatego({{$categorias->id}})" >
              ...
              <div class="m-dropdown__body">
                <div class="m-dropdown__content">
                  <ul class="m-nav">
                    ...
                    <br>
                    <li class="m-nav__item">
                      <button type="button" class="btn m-btn--pill btn-outline-success m-btn m-btn--custom m-btn--outline-2x" onclick="eliminarSubcate({{$sub->id}})" >
                        <i class="m-nav__link-icon la la-trash"></i>
                        <span class="m-nav__link-text">Eliminar</span>      
                      </button> 
                    </li>
      ...
      <div class="m-portlet__body"> 
         ...
         @foreach($archivos as $archivo)
          ...
          <tr>
            <td>{{$archivo->id}}</td>
             <td>{{$archivo->slug}}</td>
             <td style="width: 150px;"><a target="_blank" href="/{{$archivo->src_archivo}}{{$archivo->slug}}">/{{$archivo->src_archivo}}{{$archivo->slug}}</a></td>
             <td><button class= "btn m-btn--square btn-danger categoria-admin" data-toggle="modal" onclick="editarArchivo({{$archivo->id}})"nombreId = "{{$archivo->nombre}}"idArchivo="{{$archivo->id}}">Editar</button>
              <button class= "btn m-btn--square btn-danger" data-toggle="modal" onclick="eliminarArchivo({{$archivo->id}})">Eliminar</button>
             </td>  
             <td class="moverArchivo" idArchivo="{{$archivo->id}}"><button class= "btn m-btn--square btn-danger"  data-toggle="modal" data-target="#m_modal_mover_carpeta">Mover a Carpeta</button></td>          
          </tr>
         ...
         <div class="m-portlet__body"> 
          ...
          <tbody>
            ...
            <tr>
             ...
             <td>{{$archivo->slug}}</td>
             <td style="width: 150px;"><a target="_blank" href="/{{$archivo->src_archivo}}{{$archivo->slug}}">{{$archivo->src_archivo}}{{$archivo->slug}}</a></td>
             <td><button class= "btn m-btn--square btn-danger hola" data-toggle="m_modal_1" onclick="editarArchivo({{$archivo->id}})"nombreId = "{{$archivo->nombre}}">Editar</button>
              <button class= "btn m-btn--square btn-danger" data-toggle="modal" onclick="eliminarArchivo({{$archivo->id}})">Eliminar</button>
             </td>  
             <td class="moverArchivo" idArchivo="{{$archivo->id}}"><button class= "btn m-btn--square btn-danger"  data-toggle="modal" data-target="#m_modal_mover_carpeta">Mover a Carpeta</button></td>          
               ...
               <table >
                 <thead>
                  ...
                  <td style="width: 500px;">
                     <a href="/{{$fuente->src_archivo}}{{$fuente->slug}}" class="btn btn-secondary btn-sm m-btn  m-btn m-btn--icon m-btn--pill">
                      <span>
              ...
              <div class="m-dropdown__content">
               <table>
                 <thead>
                  ...
                  <td style="width: 500px;">
                     <a href="/{{$obsoleto->src_archivo}}{{$obsoleto->slug}}" class="btn btn-secondary btn-sm m-btn  m-btn m-btn--icon m-btn--pill">
                      <span>
                       <i class="fa flaticon-download"></i>
            ...
            <div class="m-dropdown__body">
              <div class="m-dropdown__content">
               <table>
                  ...
                  <td style="width: 500px;">
                     <a href="/{{$derogado->src_archivo}}{{$derogado->slug}}" class="btn btn-secondary btn-sm m-btn  m-btn m-btn--icon m-btn--pill">
                      <span>
                       <i class="fa flaticon-download"></i>
...
<div class="modal fade" id="m_modal_mover_carpeta" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        <form id="mover-carpeta-admin">
          <div class="modal-header">
...
@section("js")
  ...
  <script src="/SIG/js/admin/agregarSubcategoria.js" type="text/javascript"></script>
  <script src="/SIG/js/admin/archivo.js" type="text/javascript"></script>
@endsection
